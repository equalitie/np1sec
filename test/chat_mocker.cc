...
void check_receive_queue(evutil_socket_t fd, short what, void *arg)
{
  ...
  ((ChatMocker*)arg)->event_manager.add_timeout(check_receive_queue, arg, &(((ChatMocker*)arg)->c_check_receive_interval));
...
void EventManager::dispatch_event_loop()
{
  event_base_dispatch(base);
}

void ChatMocker::dispatch_event_loop() {
